...
<details>
<summary>@TODO: "Cursor AI"</summary>

1. Добавить в [.cursor](.cursor) и/или "memory-bank" правило
```text
Для каждого урока, с которым работает AI, проверять актуальность информации.
При проверке актуальности использовать @context7 MCP. 
Краткий результат проверки размещать в @readme.md в корне репозитария.
Подробный результат проверуи размещать в файле "ai-relevance.md" в директории урока. 
Если материал урока устарел или не полный, то в файле "ai-relevance.md" указать перечень тем, которые следует изучить.
```
2. По запросу пользователя выполнить п.1 для всех существующих уроков.
3. По запросу пользователя анализировать результат выполнения урока и указывать на: пробелы в знаниях; плохо выполненную работу.
4. Написать инстукцию по использованию Cursor AI в качестве помощника.
</details>
