 ...
 */
(function () {
    var boxEl = document.querySelector('.box'), // type = Element
    box = document.querySelector('.box'), input = document.querySelector('input'), input2 = document.querySelector('input');
    ...
    var inputText = input.value, // type = string
    inputNumber = +input.value, // Конвертация типа через трюк JavaScript
    inputNumber1 = parseInt(input.value), // Конвертация типа из строки. Правильный способ работы.
    ...
    inputNumber2 = input.value // Утверждение типа. Обманываем проверку типов TSC. На самом деле в переменной будет string
    ;
